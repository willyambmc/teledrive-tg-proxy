...
// Digunakan untuk: preview (thumbnail, gambar, video, audio, PDF) dan download
...
export default async function handler(req) {
  ...
  try {
    ...
    const tgResp = await fetch(tgUrl, {
      signal: AbortSignal.timeout(120000), // 2 menit timeout untuk file besar
    });
    ...
    const msg = error instanceof Error ? error.message : 'File proxy error';
    return new Response(
